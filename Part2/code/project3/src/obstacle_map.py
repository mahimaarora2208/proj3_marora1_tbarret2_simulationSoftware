...
OBSTACLE_SHAPES = [("CIRCLE", (2, 8), 1),
                   ("CIRCLE", (2, 2), 1),
                   ("RECTANGLE", 0.25, 1.75, 4.25, 5.75),
                   ("RECTANGLE", 3.75, 6.25, 4.25, 5.75),
                   ("RECTANGLE", 7.25, 8.75, 1, 5)]


def generate_obstacle_map(margin):
    return ObstacleMap(10, 10, OBSTACLE_SHAPES, margin)
